							...
							<ul>
								<li>
									<a href="javascript:void(0);">
										<img src="<?= base_url('assets/admin/')?>assets/img/icons/google.png" class="me-2" alt="google">
										Sign Up using Google
									</a>
								</li>
								<li>
									<a href="javascript:void(0);">
										<img src="<?= base_url('assets/admin/')?>assets/img/icons/facebook.png" class="me-2" alt="google">
